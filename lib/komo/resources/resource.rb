unless defined? Komo::Resources::Resource

module Komo::Resources

# A Komo::Resource is any file that can be found in the content directory
# or in the layout directory. This class contains information about the
# resources available to Komo.
#
class Resource
  ...
  def initialize( fn )
    @path  = fn
    @dir   = ::Komo::Resources.dirname(@path)
    @name  = ::Komo::Resources.basename(@path)
    @ext   = ::Komo::Resources.extname(@path)
  ...
  #
  def equal?( other )
    return false unless other.kind_of? ::Komo::Resources::Resource
  ...
  #
  def <=>( other )
    return unless other.kind_of? ::Komo::Resources::Resource
  ...
  def destination
    ...
    @destination = ::File.join(::Komo::Resources.config.output_dir, directory, filename)
    ext = extension
  ...
  def url
    ...
    @url = ::File.join(::Komo::Resources.config.output_dir, directory, filename)
    @url = @url.sub(::Komo::Resources.config.output_dir, '')
  end
